...
export default function KPIsScreen() {
  ...
  const getInfo = async () => {
    ...
    if (!error && !errorProductos && !errorGanancia && !errorVentas) {
        ...
        generarGraficoLineal1(resultado.sort((a, b) => b.TotalVendido - a.TotalVendido))
      ...
      datasets: [
        {
          ...
          backgroundColor: documentStyle.getPropertyValue("--color-azul").trim(),
  ...
  const generarGraficoLineal = (datos) => {
    ...
    const data = {
        ...
        datasets: [
        {
            ...
            data: ganancias,
            fill: false,
            borderColor: documentStyle.getPropertyValue("--color-verde") || "#42A5F5",
            backgroundColor: documentStyle.getPropertyValue("--color-verde") || "#42A5F5",
            tension: 0.4,
            pointBackgroundColor: "#ffffff",
            pointBorderColor: documentStyle.getPropertyValue("--color-verde") || "#42A5F5"
        }
        ]
    };
    ...
    // labels con los nombres de usuario
    const labels = datos.map(item => item.UserName);

    // datos con TotalVendido
    ...
    const data = {
        ...
        datasets: [
        {
            ...
            data: totales,
            fill: false,
            borderColor: documentStyle.getPropertyValue("--color-naranja") || "#FFA726",
            backgroundColor: documentStyle.getPropertyValue("--color-naranja") || "#FFA726",
            tension: 0.4,
            pointBackgroundColor: "#ffffff",
            pointBorderColor: documentStyle.getPropertyValue("--color-naranja") || "#FFA726"
        }
        ]
    };
      ...
      <div className="dashboard-container">
        ...
        {!loading && (
          ...
          >
            ...
            <Card style={{ width: "580px", flexShrink: 0 }}>
              <h4 style={{ textAlign: "center", marginBottom: "1rem" }}>Ganancia Estimada</h4>
                <Chart
                    type="line"
                    data={lineChartData}
                ...
                <h4 style={{ textAlign: "center", marginBottom: "1rem" }}>Total Vendido por Usuario</h4>
                <Chart
                    type="line"
                    data={lineChartData1}
