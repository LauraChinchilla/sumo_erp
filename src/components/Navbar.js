...
export default function Navbar({ onLogout }) {
  ...
  const menuItems = [
    ...
    { label: 'Inventario', icon: 'pi pi-box', command: () => navigate('/inventory') },
    { label: 'Productos', icon: 'pi pi-tags', command: () => navigate('/products') },
    { label: 'Entradas', icon: 'pi pi-sign-in', command: () => navigate('/entradas') },
    { label: 'Salidas', icon: 'pi pi-sign-out', command: () => navigate('/salidas') },
    { separator: true },
    { label: 'Configuraciones', icon: 'pi pi-cog', command: () => navigate('/config') },
    ...
    <div className="navbar">
      ...
      <div className="navbar-right">
        ...
        <Button
          ...
          icon="pi pi-bars"
          className="p-button-rounded p-button-text navbar-menu-button"
